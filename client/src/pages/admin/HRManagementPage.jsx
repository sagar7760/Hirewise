...
const HRManagementPage = () => {
  ...
  const handleUpdateHR = async () => {
    ...
    if (newHR.firstName && newHR.lastName && newHR.email && department && editingHR) {
      ...
      console.error('Validation Error: Please fill in all required fields (first name, last name, email, department)');
    }
  };

  const handleRemoveHR = async (hrId) => {
    // Replaced window.confirm() with console.log and conditional logic
    const confirmRemove = true; // Assume confirmation dialog is handled externally if necessary
  ...
  const totalJobsPosted = hrs.reduce((sum, hr) => sum + (hr.jobsPosted || 0), 0);
  const totalCandidatesHired = hrs.reduce((sum, hr) => sum + (hr.candidatesHired || 0), 0);
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              {Array.from({ length: 4 }).map((_, idx) => (
                <div key={idx} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 animate-pulse transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Active HRs</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white font-['Open_Sans']">{activeHRs}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Total Jobs Posted</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white font-['Open_Sans']">{totalJobsPosted}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Candidates Hired</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white font-['Open_Sans']">{totalCandidatesHired}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Success Rate</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white font-['Open_Sans']">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {hrs.map((hr) => (
                      <tr key={hr.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-300">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="h-10 w-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center transition-colors duration-300">
                              <span className="text-gray-700 dark:text-gray-300 font-medium font-['Open_Sans']">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full font-['Roboto'] transition-colors duration-300 ${
                            hr.status === 'active' 
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900 dark:text-white font-['Roboto']">
                            ...
                            <div className="text-gray-500 dark:text-gray-400">{hr.candidatesHired} hired</div>
                          </div>
                        </td>
        ...
        {showAddModal && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 dark:bg-black/70 overflow-y-auto h-full w-full z-50 transition-colors duration-300">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-2xl rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300">
              <div className="mt-3">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white font-['Open_Sans'] mb-4">
                  {editingHR ? 'Edit HR' : 'Add New HR'}
                </h3>
                
                {/* Error Message in Modal */}
                {error && (
                  <div className="mb-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 text-red-700 dark:text-red-400 px-3 py-2 rounded text-sm">
                    {error}
                  </div>
                )}
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent font-['Roboto'] text-gray-900 dark:text-white dark:bg-gray-700 transition-colors duration-300"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 font-['Roboto'] mb-2">
                      Password {editingHR && <span className="text-gray-500 dark:text-gray-400">(leave empty to keep current)</span>}
                    </label>
                    <div className="flex space-x-2">
                      <div className="flex-1 relative">
                        <input
                          ...
                          className="w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent font-['Roboto'] text-gray-900 dark:text-white dark:bg-gray-700 transition-colors duration-300"
                      ...
                      <button
                        ...
                        className="px-3 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-medium font-['Roboto'] transition-colors flex items-center"
                    ...
                    {newHR.password && (
                      <div className="mt-2 text-xs text-gray-600 dark:text-gray-400 font-['Roboto']">
