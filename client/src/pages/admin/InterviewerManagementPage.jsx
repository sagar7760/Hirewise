...
const InterviewerManagementPage = () => {
  ...
  const totalAssignedJobs = interviewers.reduce((sum, interviewer) => sum + (interviewer.assignedJobs || 0), 0);
  const totalCompletedInterviews = interviewers.reduce((sum, interviewer) => sum + (interviewer.completedInterviews || 0), 0);
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Active Interviewers</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white font-['Open_Sans']">{activeInterviewers}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Assigned Jobs</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white font-['Open_Sans']">{totalAssignedJobs}</p>
              </div>
            </div>
          </div>

          {/* Card 3: Completed Interviews */}
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
            <div className="flex items-center">
              <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg transition-colors duration-300">
                <svg className="w-6 h-6 text-gray-700 dark:text-gray-300 stroke-current" fill="none" viewBox="0 0 24 24">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Completed Interviews</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white font-['Open_Sans']">{totalCompletedInterviews}</p>
              </div>
            </div>
          </div>

          {/* Card 4: Avg per Interviewer */}
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
            <div className="flex items-center">
              <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg transition-colors duration-300">
                <svg className="w-6 h-6 text-gray-700 dark:text-gray-300 stroke-current" fill="none" viewBox="0 0 24 24">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-['Roboto']">Avg per Interviewer</p>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {interviewers.map((interviewer) => (
                  <tr key={interviewer.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-300">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 font-['Roboto']">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-1">
                        {interviewer.expertise.slice(0, 2).map((skill, index) => (
                          <span key={index} className="inline-flex px-2 py-1 text-xs font-medium rounded bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 font-['Roboto']">
                            {skill}
                          </span>
                        ))}
                        {interviewer.expertise.length > 2 && (
                          <span className="inline-flex px-2 py-1 text-xs font-medium rounded bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 font-['Roboto']">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 dark:text-white font-['Roboto']">
                        ...
                        <div className="text-gray-500 dark:text-gray-400">{interviewer.completedInterviews} interviews completed</div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-2xl rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300">
              <div className="mt-3">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 font-['Roboto'] mb-2">Full Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 font-['Roboto'] mb-2">Password {editingInterviewer && <span className="text-gray-500 dark:text-gray-400">(leave empty to keep current)</span>}</label>
                    <input
                      type="password"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 font-['Roboto'] mb-2">Expertise</label>
                    <div className="flex gap-2 mb-2">
                      ...
                      <button
                        ...
                        className="px-3 py-2 bg-black dark:bg-white text-white dark:text-black rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
                      >
                        Add
                      </button>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {newInterviewer.expertise.map((skill, index) => (
                        <span key={index} className="inline-flex items-center px-2 py-1 text-xs font-medium rounded bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 font-['Roboto']">
                          {skill}
                          <button
