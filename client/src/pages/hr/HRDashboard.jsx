  ...
  return (
    <HRLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="text-2xl font-bold text-gray-900 font-['Open_Sans']">{dashboardStats.totalJobs ?? 0}</dd>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="text-2xl font-bold text-gray-900 font-['Open_Sans']">{dashboardStats.totalApplicants ?? 0}</dd>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="text-2xl font-bold text-gray-900 font-['Open_Sans']">{dashboardStats.candidatesShortlisted ?? 0}</dd>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <dd className="text-2xl font-bold text-gray-900 font-['Open_Sans']">{dashboardStats.interviewsScheduled ?? 0}</dd>
                  </div>
                </div>
              </div>
            </>
          ) : (
            <div className="col-span-4 text-sm text-red-600">Failed to load statistics.</div>
          )}
        </div>
              ...
              <div className="space-y-4">
                {loadingInterviews ? (
                  ...
                  <div key={interview._id || interview.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div className="text-right">
                      <p className="text-xs text-gray-900 font-['Roboto'] font-medium">{interview.date ? new Date(interview.date).toLocaleDateString() : ''}</p>
                      <p className="text-xs text-gray-500 font-['Roboto']">{interview.time || (interview.date ? new Date(interview.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : '')}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {/* Error banner */}
        {error && (
          <div className="mt-8 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md text-sm flex justify-between items-start">
            <div>{error}</div>
            <button
              onClick={() => {
                setError(null);
